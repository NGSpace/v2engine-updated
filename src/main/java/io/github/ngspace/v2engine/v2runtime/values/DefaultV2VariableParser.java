...
import io.github.ngspace.v2engine.v2runtime.values.constants.V2Array;
import io.github.ngspace.v2engine.v2runtime.values.constants.V2Boolean;
import io.github.ngspace.v2engine.v2runtime.values.constants.V2Number;
import io.github.ngspace.v2engine.v2runtime.values.constants.V2String;
import io.github.ngspace.v2engine.v2runtime.values.modifiable.V2ArrayRead;
import io.github.ngspace.v2engine.v2runtime.values.modifiable.V2DynamicVar;
import io.github.ngspace.v2engine.v2runtime.values.modifiable.V2SetValue;
import io.github.ngspace.v2engine.v2runtime.values.modifiable.V2TempDynamicVar;
import io.github.ngspace.v2engine.v2runtime.values.operations.V2ClassPropertyCall;
import io.github.ngspace.v2engine.v2runtime.values.operations.V2MathOperation;
import io.github.ngspace.v2engine.v2runtime.values.operations.V2PostIncDecOperator;
import io.github.ngspace.v2engine.v2runtime.values.operations.V2PreIncDecOperator;
import io.github.ngspace.v2engine.v2runtime.values.operations.booloperations.V2Comparison;
import io.github.ngspace.v2engine.v2runtime.values.operations.booloperations.V2LogicalAND;
import io.github.ngspace.v2engine.v2runtime.values.operations.booloperations.V2LogicalOR;
import io.github.ngspace.v2engine.v2runtime.values.operations.booloperations.V2OppositeOperator;
